import "./Tile.css";
function Tile({ img, position,bgColor }) {
return (
    <div className={`tile ${position} ${bgColor}`}>
    <div className="img-parent">
    <img  className="about-im"src={img} alt="tile-img"/>
    </div>
    <div className="text-parent">
     <div className="blockquote mb-0">
     <h1 style={{ fontSize: "2.1em", paddingBottom: "20px", paddingRight: "20rem" }}>
              Know Who <strong className="purple">I'M</strong>
            </h1>
          <p style={{ textAlign: "justify" , fontSize:"1.5rem" }}>
            Hi Everyone, I am <span className="purple">Harshit Sachan </span>
